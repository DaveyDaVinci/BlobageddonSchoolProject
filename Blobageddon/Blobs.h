...
-(id) initWithBlobType:(int)blobType blobSize:(int)blobSize startTime:(CGFloat)time velocity:(CGPoint)velocity location:(CGPoint)location blobInterract:(BOOL)interract tag:(int)tag;
